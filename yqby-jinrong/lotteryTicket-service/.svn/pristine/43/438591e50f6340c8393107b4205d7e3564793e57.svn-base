...
public enum ErrorCodeEnum {
	...
	EXISTORDER("932100","禁止重复下单"),
	SIGNERROR("932200","验签错误"),
	ALIEQUALBAIMEIYUN("410001","绑定信息不一致"),

	LOTTERY_TICKET_DEVICE_NULL_ERROR("110000","彩票设备号为空"),
	LOTTERY_TICKET_OPENID_NULL_ERROR("110001","用户openID为空"),
	LOTTERY_TICKET_BUILD_ORDER_ERROR("110002","用户下单失败"),
	LOTTERY_TICKET_QUERY_INFO_ERROR("110003","获取彩票信息失败"),
	LOTTERY_TICKET_DEVICE_BINDING_ERROR("110004","彩票设备绑定关系为空"),
	LOTTERY_TICKET_ORDER_NO_ERROR("110005","订单编号为空"),
	LOTTERY_TICKET_THIRD_BUILD_ORDER_ERROR("110006","第三方下单失败"),
