...
public class QRCodeUtil {
	 ...
	 * @throws Exception
	 */
	public static String geneQRCodeToSting(String content, String fileName,int widht,int high) throws Exception {
       ...
       //
		...
		BufferedImage bi = new BufferedImage(widht, high,
