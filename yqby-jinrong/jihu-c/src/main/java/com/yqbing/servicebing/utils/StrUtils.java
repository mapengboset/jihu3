...
public class StrUtils {
  ...
  //去除年月日
	...
	public static String replaceSubString(String str,int n){
		String st = "";
		st = str.substring(0, str.length()-n);
	...
	//支取中文
	public static String replaceZhong(String description){
		String reg = "[^\u4e00-\u9fa5]";
		String desc = description.replaceAll(reg, "");
		String ds = desc.substring(0, 20);
		description = ds+".....";
		return description;
	}
