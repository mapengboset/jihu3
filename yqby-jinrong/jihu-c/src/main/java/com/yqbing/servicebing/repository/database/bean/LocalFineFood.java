...
public class LocalFineFood {
   ...
   private List<LocalLabel> label;
    ...
    public Short getPerPrice() {
        return perPrice;
    }

    public void setPerPrice(Short perPrice) {
    ...
    public void setSpecialDishes(String specialDishes) {
        this.specialDishes = specialDishes == null ? null : specialDishes.trim();
    }
	...
	public List<LocalLabel> getLabel() {
		return label;
	}

	public void setLabel(List<LocalLabel> label) {
		this.label = label;
	}
