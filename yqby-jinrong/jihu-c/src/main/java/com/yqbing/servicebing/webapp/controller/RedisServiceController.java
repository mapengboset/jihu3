...
public class RedisServiceController {
    ...
    @RequestMapping(value = "/redisService/delAppraise",
        	method = {RequestMethod.GET,RequestMethod.POST})
	public void delAppraise(@ApiParam(name = "userId",value = "userId") @RequestParam(value = "userId", required = false) String userId,
			@ApiParam(name = "appPack",value = "appPack 包名") @RequestParam(value = "appPack", required = true) String appPack){
		
		try {
			
			redisService.delAppraise(userId,appPack);
