...
public class BoxStoreAppRes implements Serializable{
	   
		/**
	 * 
	 */
	   private static final long serialVersionUID = -2917986137903604891L;
		/**
		 * 
		 */
...
//		private String status;//状态 1.已经下载,2没有下载
		...
		private String click;//上报地址
		private String show;//展示上报
		private String download;//下载上报
		private String install;//安装完成上报
		private Integer type;//1普通 2.任务
		private Integer localstatus;//0.下载 1.打开
