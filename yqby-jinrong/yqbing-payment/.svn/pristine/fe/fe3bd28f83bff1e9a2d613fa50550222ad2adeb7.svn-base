...
public class TWxApayOrderBean {
    private Long id;

    private String platOrder;
    ...
    private String bmchId;

    private String bdeviceInfo;

    private String bnonceStr;
    ...
    public String getPlatOrder() {
        return platOrder;
    }

    public void setPlatOrder(String platOrder) {
        this.platOrder = platOrder == null ? null : platOrder.trim();
    }
    ...
    public void setBappId(String bappId) {
        this.bappId = bappId == null ? null : bappId.trim();
    }

    public String getBmchId() {
        return bmchId;
    }

    public void setBmchId(String bmchId) {
        this.bmchId = bmchId == null ? null : bmchId.trim();
    }

    public String getBdeviceInfo() {
        return bdeviceInfo;
    }

    public void setBdeviceInfo(String bdeviceInfo) {
        this.bdeviceInfo = bdeviceInfo == null ? null : bdeviceInfo.trim();
    }

    public String getBnonceStr() {
        return bnonceStr;
    }

    public void setBnonceStr(String bnonceStr) {
        this.bnonceStr = bnonceStr == null ? null : bnonceStr.trim();
    }
    ...
    public void setBtradeType(String btradeType) {
        this.btradeType = btradeType == null ? null : btradeType.trim();
    }
