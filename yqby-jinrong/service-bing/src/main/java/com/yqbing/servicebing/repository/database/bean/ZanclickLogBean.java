...
public class ZanclickLogBean {
    ...
    private BigDecimal settleamounthuabei;

    private BigDecimal huabeiprice;
    ...
    public BigDecimal getSettleamounthuabei() {
		return settleamounthuabei;
	}

	public void setSettleamounthuabei(BigDecimal settleamounthuabei) {
		this.settleamounthuabei = settleamounthuabei;
	}

	public BigDecimal getHuabeiprice() {
		return huabeiprice;
	}

	public void setHuabeiprice(BigDecimal huabeiprice) {
		this.huabeiprice = huabeiprice;
	}
