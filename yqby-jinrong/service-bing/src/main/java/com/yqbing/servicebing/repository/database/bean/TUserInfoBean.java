...
public class TUserInfoBean {
	...
	public Integer getUserBrith() {
		return userBrith;
	}

	public void setUserBrith(Integer userBrith) {
	...
	public void settToken(String tToken) {
		this.tToken = tToken == null ? null : tToken.trim();
	}
	...
	public Short gettGender() {
		return tGender;
	}

	public void settGender(Short tGender) {
	...
	public Byte getAppchannel() {
		return appchannel;
	}

	public void setAppchannel(Byte appchannel) {
