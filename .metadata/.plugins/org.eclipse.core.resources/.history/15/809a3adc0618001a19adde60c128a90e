...
public class StoreInfoServiceImpl extends CommonService implements StoreInfoService{
	...
	public String queryStoreInfo(String token) {
		...
		if(storeInfo != null){
			...
			String area = storeInfo.getAreaName()==null?"":storeInfo.getAreaName();
			sq.setCitys(storeInfo.getProvinceName()+"-"+storeInfo.getCityName()+"-"+area);
